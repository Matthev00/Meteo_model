...
def _normalise_norm_like(array, attr_name: str, stats):
...
def _normalise_snow(array, stats):
...
def _inverse_normalize_norm_like(array, attr_name, stats):
    mean = stats[attr_name]["mean"]
    std = stats[attr_name]["std"]
...
def inverse_normalize_data(df, stats):
